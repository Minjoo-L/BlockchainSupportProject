...
return{
	/*후원자 회원가입*/
	registerSupporter: function(req, res){
	...
	/*신청한 피후원자 전체 정보 확인*/
	get_all_appliedReci: function(req, res){
		console.log("getting all applied Recipient from database: ");
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
			...
			const request = {
		        ...
		        txId: tx_id,
		        fcn: 'getApplyReciInfo',
		        args: ['']
		    };
		    // send the query proposal to the peer
		    return mychannel1.queryByChaincode(request);
	...
	add_recipient: function(req, res){
